<script lang="ts">
	...
	// for dev env
	var phpLink: string = 'http://localhost:9090/';
	// if (!conf.ENV.DEV) {
	// 	phpLink = 'https://';
	// }
</script>
...
<footer>
	<a class="php-api" rel="external noreferrer" href={phpLink} target="_blank">Link</a>
	<a class="php-api" rel="external noreferrer" href={phpLink} target="_blank">Link</a>
	<div class="withLove">
